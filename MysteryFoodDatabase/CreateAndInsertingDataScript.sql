/*Please change varchar CHARACTER VARYING
change all double quotes to single
all integer to be cast as bits
rating is a bit not a integer out of 5
link recipe to ingredients via recipeingredients table
Cuisine table, take out all cuisine and replace with Id*/
...
Heat some oil in a non-stick pan and add enough batter for one pancake. Lower the heat, cover with a lid and leave for 2–3 minutes. Turn the pancake over and cook for 1 minute on the other side. Slide onto a warm plate and make the rest of the pancakes.","Greek",0),
